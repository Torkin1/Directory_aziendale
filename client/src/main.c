...
#define SHORT_OPTS ""
void printOps(){
    logMsg(I, "Here is a list of supported operations. Please note that You must have the correct privileges for an operation in order to execute it. For executing an operation, type it in the format: opCode[:{arg0 | NULL}:...]\n");
