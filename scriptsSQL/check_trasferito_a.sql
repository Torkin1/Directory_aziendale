-- controlla se un dipendente registrato come assegnato a una postazione risulti prima come trasferito a tale postazione. Nel caso non lo sia invia un segnale di errore.
