...
BEGIN
	...
	if not (select NumTelefonicoEsternoPostazione, `Data` from TRASFERITO_A where TRASFERITO_A.NumTelefonicoEsternoPostazione = numTelefonicoEsternoPostazione and TRASFERITO_A.`Data` = dataUltimoTrasferimento)
